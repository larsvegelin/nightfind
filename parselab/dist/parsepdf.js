...
en:{keep:"Use",drop:"Leave out",autoNamed:"named automatically",selectAll:"Select all",selectNone:"Select none",chosen:"{n} of {t} on",aiChanged:"The AI changed {n} fields.",approve:"Approve",undo:"Undo",approved:"Approved.",undone:"Reverted.",ocr:"Recognise text (OCR)",ocrBusy:"Recognising text…",ocrDone:"{n} pieces of text recognised. Check them; recognition is not always right.",ocrOff:"Text recognition could not be loaded. Check your connection.",ocrHint:"This document has no text layer. Run text recognition to pull fields out of it anyway."},
...
return {kaart:kaart,opslaanKnop:opslaanKnop,lees:lees,bewaar:bewaar,nieuweMap:nieuweMap,verwijderMap:verwijderMap,map:map,kiesMap:kiesMap,
...
if(perMap){
  var keus=SJ.kies(mapId,doc,window.PLP_ST.analyse(doc));
  if(keus){regels=keus.sjabloon.regels.filter(bruikbaar);naam=keus.sjabloon.naam;
